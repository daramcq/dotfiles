...
(defun create-named-term-processes (buffer-list)
  ;;; Create multiple named terminal processes
  (interactive)
  (loop for bufname in buffer-list
        do
        (create-terminal-buffer bufname)
        (term-send-string
         (get-buffer-process bufname)
         (format "zdi %s restart -d\r" bufname))))

(defun voice-run-all()
  ;;; Run all the voice containers in development mode
  (interactive)
  (create-named-term-processes '("voice" "voice_resque" "voice_resque_low" "voice_consumers")))

(defun voice-run-light()
  ;;; Run all the voice containers in development mode
  (interactive)
  (create-named-term-processes '("voice" "voice_resque")))
#+END_SRC
** Theme
